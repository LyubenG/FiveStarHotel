...
namespace FiveStarHotel1.User_Controls
{
    public partial class AddRoom : UserControl
    {
        ...
        private void AddRoom_VisibleChanged(object sender, EventArgs e) //if room is selected/visible table is being refreshed
        {
            UpdateRoomData();
        }

        private void btnAddRoom_Click(object sender, EventArgs e) // button that adds new room
        {
            if (ValidateInput())
            {
        ...
        private void btnRemove_Click(object sender, EventArgs e) //button removes selected room
        {
        ...
        private void btnEditRoom_Click(object sender, EventArgs e) //button that edits selected room
        {
